...
CARD_TEMPLATE_PATH = '/home/daniel/Documents/myCode/Omniplexium-Eternal/img/cardTemplate.png'
...
def generateCardImageFromItemId(cardId: str, title_left_offset: int = 70) -> Image:
    ...
    try:
        ...
        # Reduced attack font size slightly for better spacing
        ...
        # Reduced description font size slightly
        ...
        # Modified spacing values for more compact layout
        attack_start_y = 1150  # Moved starting position up slightly
        attack_x = 50
        spacing = 180  # Reduced spacing between attacks
        description_offset_y = 50  # Reduced space between attack name and description
        ...
        for attack_name, attack_description in zip(attackNames, attackDescriptions):
            ...
            for line in wrapped_lines:
                ...
                description_y += description_font.size + 3  # Reduced line spacing
            
            # Update Y position for next attack with modified spacing calculation
            line_count = len(wrapped_lines)
            current_y += spacing + (line_count - 1) * (description_font.size + 3)
