...
async def createUsersTable() -> None:
...
async def createLoginRewardsTable() -> None:
    with sqlite3.connect(DATABASE_PATH) as conn:
        cursor = conn.cursor()
...
async def createCardTables() -> None:
    with sqlite3.connect(DATABASE_PATH) as conn:
        cursor = conn.cursor()
...
async def createAttacksTable() -> None:
    with sqlite3.connect(DATABASE_PATH) as conn:
        cursor = conn.cursor()
...
async def makeLoginRewardsTable() -> None:
    with sqlite3.connect(DATABASE_PATH) as conn:
        try:
            cursor = conn.cursor()
...
async def createAllTables() -> None:
    await createUsersTable()
    await createLoginRewardsTable()
    await createCardTables()
    await createAttacksTable()
    await makeLoginRewardsTable()
